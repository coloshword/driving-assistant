...
| `sherpa-onnx-kokoro-en-v0_19/` | Kokoro text-to-speech, fp32 (default; fastest) | 353 MB |
| `sherpa-onnx-kokoro-int8-en-v0_19/` | Kokoro int8 (optional, `KOKORO_INT8=1`; smaller but ~2x slower) | ~150 MB |
